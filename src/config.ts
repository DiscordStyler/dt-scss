...
export interface Config {
  ...
  /**
   * The available Discord Theme META.
   */
  meta: {
    /**
    ...
    version: string;
    /** Describe your theme in a short sentence. */
    description: string;
   ...
   * Example being Horizontal Server List and it's add-on.
   * 
   ...
   * you're building to a different directory use this to change it.
   * 
   * Example: `https://discordstyler.github.io/CatppuccinMocha/CatppuccinMocha.css`
   */
  baseImport?: string;
}
